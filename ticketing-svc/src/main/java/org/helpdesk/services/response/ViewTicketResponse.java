...
public class ViewTicketResponse {
	 ...
	 * @return the outage
	 */
	@XmlElement  public String getOutage() {
		return outage;
	}
	/**
	 * @return the accesslevel
	 */
	@XmlElement  public String getAccesslevel() {
		return accesslevel;
	}
	/**
	 ...
	 */
	@XmlElement  public String getRequestContext() {
	 ...
	 */
	@XmlElement  public String getVerifyCpFlag() {
		return verifyCpFlag;
	}
	/**
	 ...
	 */
	@XmlElement  public String getPrivilege_level() {
	 ...
	 */
	@XmlElement  public String getAccess_level() {
		return access_level;
	}
	/**
